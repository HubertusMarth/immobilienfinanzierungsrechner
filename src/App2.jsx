...
export default function App() {
  ...
  // Gesamtrückzahlung (Darlehen + Zinsen), inkl. Sondertilgung automatisch enthalten
  ...
  return (
    <div style={{ maxWidth: 820, margin: "40px auto", fontFamily: "system-ui" }}>
      ...
      <p>
        Gib die Eckdaten deiner Finanzierung ein. Der Rechner berechnet Darlehen,
        Rate, Restschuld, Laufzeit, Zinsen sowie einen Tilgungsplan (jährlich).
      </p>
